        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
				{
					...
					float4 vertexToFrag11 = mul( unity_Projector, float4(inputMesh.positionOS,0) );
					outputPackedVaryingsMeshToPS.ase_texcoord = vertexToFrag11;
					float4 vertexToFrag15 = mul( unity_ProjectorClip, float4(inputMesh.positionOS,0) );
					outputPackedVaryingsMeshToPS.ase_texcoord1 = vertexToFrag15;
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput ) : SV_Target
				{
					...
					BuiltinData builtinData;
					SurfaceDescription surfaceDescription = (SurfaceDescription)0;
					float4 vertexToFrag11 = packedInput.ase_texcoord;
					...
					float4 vertexToFrag15 = packedInput.ase_texcoord1;
					
					surfaceDescription.Color =  ( appendResult25 * tex2D( _FalloffTex, ( (vertexToFrag15).xy / (vertexToFrag15).w ) ).a ).xyz;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
...
/*ASEBEGIN
Version=16800
-1990;938;1906;1005;1826.384;350.4166;1;True;True
Node;AmplifyShaderEditor.ColorNode;37;-608,-192;Float;False;Property;_Color;Color;2;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ComponentMaskNode;22;-828,127;Float;True;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;18;-432,0;Float;True;Property;_LightTex;LightTex;0;0;Create;True;0;0;False;0;None;9c75440c42d9bd1458d4e497d76b8c1a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;21;-852,-203;Float;True;True;True;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=BAE80D3636CEC0DF2A766BEDCAB92F33BF033461